...
namespace Weifenxiao.DAL
{
    public class PageData
    {
        ...
        //    SqlDataReader sdr = Jnwf.Utils.Data.SqlHelper.ExecuteReader(WebConfig.WeifenxiaoRW, CommandType.StoredProcedure, "P_GridViewPager", paras);
            ...
            )
        {
            ...
            ds = Jnwf.Utils.Data.SqlHelper.ExecuteDataset(WebConfig.WfxRW, CommandType.StoredProcedure, "P_GridViewPager", paras);

...
public partial class distribution_Withdrawals : System.Web.UI.Page
{
    public int type
    {
        get
    ...
    public void BindData()
    {
        ...
        if (identity != null)
        {
            ...
            DataSet ds = Weifenxiao.BLL.ApplyBLL.GetInstance().GetListByPage(pager1.PageSize, CurrentPage, "shopid=" + identity.ShopID + " and status=0", out allCount);

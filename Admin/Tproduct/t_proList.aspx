<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="t_proList.aspx.cs" Inherits="Tproduct_t_proList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="Server">
    <section>
        <div class="page_title">
            <h2><strong>商品列表</strong><a class="fr top_rt_btn" href="/Tproduct/t_proEdit.aspx">添加组团商品</a></h2>
        </div>
        ...
        <div class="m-prolist">
            <table class="table">
                ...
                <asp:Repeater ID="rptResultsList" runat="server">
                    <ItemTemplate>
                        <tr class="<%#DataBinder.Eval(Container.DataItem,"Status").ToString()=="-2"?"notserving":""%> " pid="<%#DataBinder.Eval(Container.DataItem,"ProductId") %>">
                            <td>
                                <div class="proimg">
                            ...
                            <td><%#DataBinder.Eval(Container.DataItem,"GroupPrice") %>元</td>
                            <td><%#DataBinder.Eval(Container.DataItem,"GroupNumber") %>人</td>
                            ...
                            <td>
                                <a href="/Tproduct/t_proEdit.aspx?proId=<%#DataBinder.Eval(Container.DataItem,"ProductId") %>" class="inner_btn">编辑</a><br />
                                <a href="/Tproduct/t_skuEdit.aspx?proId=<%#DataBinder.Eval(Container.DataItem,"ProductId") %>" class="inner_btn">SKU修改</a><br />
    ...
    <script>
        ...
        function fnChangeOrderBy(t, pid) {
            ...
            $.getJSON(
                "/data/tproduct.ashx?type=quanzhong&pid=" + pid + "&orderby=" + orderby,
                function (msg) {
                    if (msg.result == "ok") {
        ...
        function fnChangeStatus(s, pid) {
            ...
            $.getJSON(
                "/data/tproduct.ashx?type=" + s + "&pid=" + pid,
                function (msg) {
                    debugger;
                    if (msg.result == "ok") {
                        if (s == "shanchu") {

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="t_attrSkuEdit.aspx.cs" Inherits="Tproduct_t_attrSkuEdit" %>
            ...
            if (!!result_json) {
                ...
                $.post("t_attrSkuEdit.aspx", {
                    ...
                    if (data == 1) {
                        fnShowMsg("添加成功，正在跳转~");
                        setTimeout(function () {
                            location.href = "t_skuEdit.aspx?proid=" + productid;
                            return false;
                        }, 500);
                    }
                }, "json");

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="skuEdit.aspx.cs" Inherits="product_skuEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="Server">
    ...
    <div class="page_title">
        <h2><strong>商品库存</strong><a class="fr top_rt_btn" href="attrSkuEdit.aspx?proId=<%=productId %>">设置产品属性</a></h2>
    </div>
    <div class="proitem">

...
public partial class product_proList : System.Web.UI.Page
{
    public int type
    {
        get
    ...
    private void BindData()
    {
        ...
        if (identity != null)
        {
            ...
            DataSet ds = Weifenxiao.BLL.ProductsBLL.GetInstance().GetListByPage(pager1.PageSize, CurrentPage, "shopid=" + identity.ShopID + " and status <>-1", out allCount);
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = Weifenxiao.BLL.ProductsBLL.GetInstance().GetListByPage(pager1.PageSize, CurrentPage, " 1=1 " + where, out allCount);
